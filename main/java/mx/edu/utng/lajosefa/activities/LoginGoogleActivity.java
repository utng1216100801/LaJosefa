...
import mx.edu.utng.lajosefa.Navigation_drawerActivity;
...
public class LoginGoogleActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin = findViewById (R.id.btn_login_google);
    ...
    private void goMainScreen() {
        Intent intent = new Intent(this, Navigation_drawerActivity.class);
